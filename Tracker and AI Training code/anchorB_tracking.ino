...
#define ANCHOR_ADD "0B:00:5B:D5:A9:9A:E2:9C" //Make sure this is different from all other ESP32 addresses
...
// MQTT
const char* mqtt_server = ""; // NEEDS TO CHANGE WHEN WIFI CHANGES
const char* data_topic_1 = "range_data/rangeB/range";
const char* mqtt_username = ""; // gets set up on the Raspberry Pi
const char* mqtt_password = ""; // gets set up on the Raspberry Pi
